...
export default class EditPageModal extends Modal {
  ...
  title() {
    ...
    return title
      ? title
      : app.translator.trans('fof-pages.admin.edit_page.title');
  }
      ...
      <div className="Modal-body">
        <div className="Form">
          <div className="Form-group">
            ...
            <input className="FormControl" placeholder={app.translator.trans('fof-pages.admin.edit_page.title_placeholder')} value={this.pageTitle()} oninput={e => {
          ...
          <div className="Form-group">
            ...
            <input className="FormControl" placeholder={app.translator.trans('fof-pages.admin.edit_page.slug_placeholder')} value={this.slug()} oninput={e => {
